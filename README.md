...
[![Build Status](https://travis-ci.org/mhatta/onionscan.svg?branch=onionscan-0.2)](https://travis-ci.org/mhatta/onionscan) [![Go Report Card](https://goreportcard.com/badge/github.com/mhatta/onionscan)](https://goreportcard.com/report/github.com/mhatta/onionscan)
...
See <a href="https://github.com/mhatta/onionscan/wiki">the wiki</a> for guidance.
...
run `go install github.com/mhatta/onionscan` and then run the binary in `$GOPATH/bin/onionscan`.

Alternatively, you can just do `go run github.com/mhatta/onionscan.go` to run without compiling.
